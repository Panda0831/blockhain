...
Pour signer, on génère un point temporaire dont on extrait l'abscisse $r$, et on calcule une valeur $s$ liée au message et à la clé privée. Le validateur peut utiliser uniquement la clé publique pour reconstruire ce point géométrique et vérifier qu'il retombe exactement au même endroit, prouvant l'authenticité sans jamais dévoiler la clé privée. »
