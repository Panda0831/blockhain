...
class RoleActeur(Enum):
    """Définit les différents rôles des participants dans le réseau Hazo Lova."""
...
class Acteur:
    ...
    def creer_transaction(self, destinataire_cle_pub, donnees, secteur, description="", montant=0):
        """
