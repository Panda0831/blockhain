...
import "./land.css";
import { authService, landService } from "./services/api";
...
export default function LandModule() {
  ...
  const [activeTab, setActiveTab] = useState<"my" | "request" | "admin">(
    isAdmin ? "admin" : "my",
  );
  ...
  const fetchData = async () => {
    ...
    try {
      console.log(
        "[DEBUG] Fetching parcels for user public_key:",
        user.public_key,
      );
      // 1. Toujours charger les parcelles de l'utilisateur (pour le menu déroulant de transfert)
      if (user.public_key) {
        const myParcelIds = await landService.getParcelsByOwner(
          user.public_key,
        );
        console.log("[DEBUG] Received parcels:", myParcelIds);
      ...
      setAllUsers(
        usersData.filter((u: any) => u.public_key !== user.public_key),
      );

      // 3. Charger les données spécifiques à l'onglet
      if (activeTab === "admin" && isAdmin) {
        console.log("[DEBUG] Fetching admin pending requests");
        const data = await landService.getPending();
        console.log("[DEBUG] Pending requests:", data);
  ...
  const handleRequest = async (e: React.FormEvent) => {
    ...
    try {
      await landService.request({
        ...
        description:
          regData.description || "Nouvelle immatriculation de parcelle",
      });
  ...
  const landStats = [
    {
      ...
      value: (parcels.length * 1250).toLocaleString() + " m²",
          ...
          >
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                fontSize: "14px",
                color: activeTab === "my" ? "var(--navy)" : "#94a3b8",
                borderBottom:
                  activeTab === "my"
                    ? "3px solid var(--navy)"
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                fontSize: "14px",
                color: activeTab === "request" ? "var(--navy)" : "#94a3b8",
                borderBottom:
                  activeTab === "request"
                    ? "3px solid var(--navy)"
                    : "3px solid transparent",
            ...
            {isAdmin && (
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: "14px",
                  color: activeTab === "admin" ? "var(--navy)" : "#94a3b8",
                  borderBottom:
                    activeTab === "admin"
                      ? "3px solid var(--navy)"
                      : "3px solid transparent",
              ...
              <div className="parcels-section">
                  ...
                  <>
                    <div className="search-filter-bar">
                      <div className="search-input-wrapper">
                        ...
                        <input
                          type="text"
                          placeholder="Rechercher une parcelle (ID, Commune...)"
                        />
                      </div>
                    </div>
                      ...
                      <div className="parcels-grid">
                        {parcels.length === 0 ? (
                          ...
                          >
                            ...
                            >
                              Aucune propriété détectée sur ce compte.
                            </p>
                            <button
                          ...
                          parcels.map((p, idx) => (
                            <div key={idx} className="parcel-card">
                              ...
                              <div className="parcel-info-row">
                                ...
                                <span className="parcel-value">?? m²</span>
                              </div>
                              <div className="parcel-actions">
                                <button className="parcel-btn btn-details">
                                  <Info size={14} /> Consulter
                                </button>
                                <button
                                  className="parcel-btn btn-transfer"
                                  onClick={() =>
                                    setTransferData({
                                      ...transferData,
                                      parcelId: p.id,
                ...
                {activeTab === "request" && (
                  ...
                  >
                    ...
                    >
                      Remplissez ce formulaire pour soumettre votre dossier de
                      propriété à l'administration foncière.
                    </p>
                    <form className="mutation-form" onSubmit={handleRequest}>
                      <div className="form-field">
                        <label className="form-label">
                          Justificatifs (Titre, Acte, Certificat)
                        </label>
                        <div
                          ...
                          style={{
                            ...
                            textAlign: "center",
                            cursor: "pointer",
                            background: regData.fileName
                              ? "rgba(45, 122, 88, 0.05)"
                              : "var(--off-white)",
                            borderColor: regData.fileName
                              ? "var(--emeraude)"
                              : "#e2e8f0",
                            position: "relative",
                          }}
                          onClick={() =>
                            document.getElementById("land-file-input")?.click()
                          }
                        >
                          <input
                            type="file"
                          ...
                          {regData.fileName ? (
                            ...
                            >
                              ...
                              <span style={{ fontSize: "11px", opacity: 0.5 }}>
                                Document prêt pour scellage blockchain
                              </span>
                            </div>
                          ) : (
                            <div
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              Une fois approuvé, ce titre sera scellé
                              cryptographiquement et associé à votre clé
                              publique.
                            </span>
                          </div>
                        </div>
                      </div>
                      <button type="submit" className="btn-submit-mutation">
                        ENVOYER LE DOSSIER AU CADASTRE
                      </button>
                    </form>
                  </div>
                )}
                        ...
                        pendingRequests.map((req, idx) => (
                          ...
                          >
                            <div className="req-info">
                              ...
                              >
                                Par: {req.requester_id.substring(0, 20)}...
                              </div>
                              <div
                            ...
                            >
                              <button
                                className="parcel-btn btn-details"
                                onClick={() =>
                                  window.open(req.document_url, "_blank")
                                }
                              >
                                <FileText size={14} /> Voir Doc
                              </button>
                              <button
                                className="parcel-btn btn-transfer"
              ...
              <div className="land-sidebar-actions">
                ...
                <div className="mutation-card">
                  <form className="mutation-form" onSubmit={handleTransfer}>
                    ...
                    <button type="submit" className="btn-submit-mutation">
                      SIGNER & INITIALISER LA MUTATION
                    </button>
                  </form>
                </div>
                ...
                <div className="land-history-card">
                  ...
                  <div className="land-activity-list">
                    {[
                      {
                        type: "CERT",
                        desc: "Titre HZL-LND-92 scellé",
                        time: "Il y a 2h",
                      },
                      {
                        type: "MOVE",
                        desc: "Mutation en cours vers 0x82...a1",
                        time: "Il y a 1j",
                      },
                      {
                        type: "NEW",
                        desc: "Dossier déposé : Parcelle A22",
                        time: "12 Mai 2026",
                      },
                    ].map((act, i) => (
